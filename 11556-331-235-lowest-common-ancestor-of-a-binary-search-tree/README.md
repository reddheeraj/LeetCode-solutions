<h2> 11556 331
235. Lowest Common Ancestor of a Binary Search Tree</h2><hr><div bis_skin_checked="1"><p>Given a binary search tree (BST), find the lowest common ancestor (LCA) node of two given nodes in the BST.</p>
